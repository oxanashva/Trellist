...
export function DatePicker({ task, onUpdateTask, onClose }) {
  ...
  const [fields, setFields, handleChange, handleBlur, handleDateInputChange, handleCalendarChange] =
                  ...
                  <label htmlFor="due-checkbox" className="date-checkbox">
                    ...
                    <span className={dueCheckIconClass}>
                      <CheckboxCheckIcon
                        width={16}
                        height={16}
                        fill={isDueDateSet ? '#ffffff' : 'transparent'}
                      />
                    </span>
                  </label>
                  <input
