...
export function TaskPreview({ id, task, taskActions, members, className }) {
  ...
  const closedTaskClass = task?.closed ? 'task-preview-closed' : ''
      ...
      >
        ...
        {task.cover?.coverColor && (
          <div
            ...
            style={{ backgroundColor: coverColorsMap[task.cover?.coverColor] }}
          ></div>
        )}
        ...
        {task?.closed && (
          <button className="task-btn archive-btn" onClick={onRemoveTask}>
