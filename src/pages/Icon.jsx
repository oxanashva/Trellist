import MemberIcon from '../assets/images/icons/member.svg?react'
...
import Label from '../assets/images/icons/label.svg?react'
import Activity from '../assets/images/icons/activity.svg?react'
import Archive from '../assets/images/icons/archive.svg?react'
...
import CircleCheck from '../assets/images/icons/circle-check.svg?react'
import Image from '../assets/images/icons/image.svg?react'
import CommentText from '../assets/images/icons/comment-text.svg?react'
import Clock from '../assets/images/icons/clock.svg?react'
import Checklist from '../assets/images/icons/checklist.svg?react'
import MemberPlus from '../assets/images/icons/member-plus.svg?react'
import Attachment from '../assets/images/icons/attachment.svg?react'
import ThumbsUp from '../assets/images/icons/thumbs-up.svg?react'
import Description from '../assets/images/icons/description.svg?react'
import Comment from '../assets/images/icons/comment.svg?react'
import ShevronUp from '../assets/images/icons/shevron-up.svg?react'
...
export function Icon() {
    return (
        <>
            <MemberIcon width={16} height={16} fill="currentColor" />
            ...
            <Info width={16} height={16} fill="currentColor" />
            <Share width={16} height={16} fill="currentColor" />
            <Label width={16} height={16} fill="currentColor" />
            <Activity width={16} height={16} fill="currentColor" />
            <Archive width={16} height={16} fill="currentColor" />
            <Minus width={16} height={16} fill="currentColor" />
            <Close width={16} height={16} fill="currentColor" />
            <Plus width={16} height={16} fill="currentColor" />
            <Edit width={16} height={16} fill="currentColor" />
            <Circle width={16} height={16} fill="currentColor" />
            <CircleCheck width={16} height={16} fill="currentColor" />
            <Image width={16} height={16} fill="currentColor" />
            <CommentText width={16} height={16} fill="currentColor" />
            <Clock width={16} height={16} fill="currentColor" />
            <Checklist width={16} height={16} fill="currentColor" />
            <MemberPlus width={16} height={16} fill="currentColor" />
            <Attachment width={16} height={16} fill="currentColor" />
            <ThumbsUp width={16} height={16} fill="currentColor" />
            <Description width={16} height={16} fill="currentColor" />
            <Comment width={16} height={16} fill="currentColor" />
            <ShevronUp width={16} height={16} fill="currentColor" />
